...
public class CreateScheduledFlowCommandConsumer : IConsumer<CreateScheduledFlowCommand>
{
    private readonly IScheduledFlowEntityRepository _repository;
    private readonly IPublishEndpoint _publishEndpoint;
    private readonly ILogger<CreateScheduledFlowCommandConsumer> _logger;

    public CreateScheduledFlowCommandConsumer(
        IScheduledFlowEntityRepository repository,
        IPublishEndpoint publishEndpoint,
        ILogger<CreateScheduledFlowCommandConsumer> logger)
    {
    ...
    public async Task Consume(ConsumeContext<CreateScheduledFlowCommand> context)
    {
        ...
        {
            _logger.LogWarning("Duplicate key error in CreateScheduledFlowCommand: {Error}", ex.Message);
