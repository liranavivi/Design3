...
namespace EntitiesManager.IntegrationTests.DestinationTests;

public abstract class DestinationIntegrationTestBase : IAsyncLifetime
{
    ...
    protected DestinationIntegrationTestBase()
    {
    ...
    public async Task InitializeAsync()
    {
        ...
        Database = mongoClient.GetDatabase("DestinationTestDb");
    ...
    protected DestinationEntity CreateTestDestination(string name = "TestDestination", string version = "1.0.0", string address = "test://")
    {
